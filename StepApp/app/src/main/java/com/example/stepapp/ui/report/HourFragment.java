...
public class HourFragment  extends Fragment {
    ...
    public Cartesian createColumnChart(){
        ...
        // DONE 1: Get the map with hours and number of steps for today
        //  from the database and initialize it to variable stepsByHour
        stepsByHour = StepAppOpenHelper.loadStepsByHour(getContext(),current_time); //line 42 HourFragment var

        // DONE 2: Creating a new map that contains hours of the day from 0 to 24 and
        ...
        graph_map.putAll(stepsByHour); //see below
